...
public class Archiver {
    ...
    private static void encode(File source) throws IOException {     // функция что кодирует исходник
        ...
        compressedFile = new File(inputFile.getAbsolutePath() + ".crp");
        ...
        double idealRatio = Math.round(operator.getCompressionRatio() * 100)
                / (double) 100;                                     //идеализированный коэффициент
